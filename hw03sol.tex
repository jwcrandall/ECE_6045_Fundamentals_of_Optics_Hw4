...
A spherical waterfront under the paraxial approximation where $z >> |x|, |y|$ such that $r=\sqrt{x^2 + y^2 + z^2} = z\sqrt{1+\frac{x^2 + y^2}{z^2}} \approx z + \frac{x^2 + y^2}{2z}$ leads to a spherical wave with a generic form of $E(x,y,z,t) = \frac{A_0}{\lambda_z}\cos \left[kz + k \right].\\
